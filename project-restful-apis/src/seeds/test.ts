...
//console.log(faker.commerce.productName()) : in ra tên ngẫu nhiên

//console.log (faker.commerce.price({ min: 100, max: 200 })) : in ra giá ngẫu nhiên
...
mongoose
  ...
  async function run () {
    ...
    for (let i = 0; i <= 5; i++){
        ...
        //console.log (faker.commerce.price({ min: 100, max: 200}))
    }
  }
